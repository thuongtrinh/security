...
public class BadPaddingExamples {
    ...
    public static byte[] encryptAndDecryptUsingDifferentKeys(byte[] plainTextBytes)
        ...
        SecretKey encryptionKey = CryptoUtils.getKeyForText("Key12345IsASuperCoolSite");
    ...
    public static byte[] encryptAndDecryptUsingDifferentAlgorithms(SecretKey key, IvParameterSpec ivParameterSpec, byte[] plainTextBytes)
            throws InvalidKeyException, GeneralSecurityException {
